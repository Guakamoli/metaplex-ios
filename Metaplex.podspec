...
Pod::Spec.new do |s|
  s.name         = "Metaplex"
  s.version          = '1.0.4'
  s.summary          = 'This is a open source library on pure swift for Metaplex protocol.'


  s.description      = <<-DESC
 This is a open source library on pure swift for Metaplex protocol.
                       DESC
  ...
  s.source_files = 'Sources/Metaplex/**/*'
